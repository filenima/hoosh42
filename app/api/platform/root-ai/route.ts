...
8. send_broadcast — ارسال اطلاعیه درون‌برنامه‌ای به همه کاربران. args: {"title":"...","body":"...","type":"INFO|WARNING|PROMO|FEATURE","confirm":false}
   ⚠️ ابتدا با confirm:false پیش‌نویس را بساز؛ پس از تأیید صریح سوپرادمین (پیام «تأیید/بفرست») دوباره با همان title و body و "confirm":true صدا بزن.
  ...
  try {
    ...
    for (let iteration = 0; iteration < MAX_TOOL_ITERATIONS; iteration++) {
      ...
      try {
        ...
        finalReply =
          "⚠️ ارتباط با موتور هوش مصنوعی برقرار نشد — لطفاً چند لحظه بعد دوباره بپرسید." +
