...
export async function POST(req: NextRequest) {
 ...
 // PASSWORD-VIEW: کپی رمز‌شده هم هم‌زمان تازه شود تا نمایش رمز در حساب
 // کاربری همیشه به‌روز باشد (لازم نیست کاربر بیرون برود و دوباره وارد شود).
 try {
 const { encryptPassword } = await import("@/lib/password-vault");
 updates.passwordEnc = encryptPassword(newPassword);
 } catch {
 /* نمایش رمز اختیاری است — تغییر رمز نباید شکست بخورد */
 }
 }
