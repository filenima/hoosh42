...
const SIDE_ITEMS: NavEntry[] = [
 ...
 { id: "invoices", label: "فاکتورها", icon: ShoppingCart },
 // دکمه AI در وسط
 { id: "inventory", label: "انبار", icon: Package },
 { id: "reports-builder", label: "گزارش‌ها", icon: BarChart3 },
];
...
export function MobileBottomNav({
 ...
 className="absolute -top-2 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-600/30 ring-4 ring-background"
 >
 {/* حلقه پالس — محدود به ۳ تکرار (قبلاً بی‌نهایت بود) */}
 <span
 className="absolute inset-0 rounded-full bg-indigo-500/40 animate-ping-finite"
 aria-hidden="true"
 />
...
: "text-muted-foreground"
 ...
 {/* نوار فعال در پایین */}
 <motion.span
 className="absolute bottom-0 h-0.5 rounded-full bg-indigo-600 dark:bg-indigo-400"
 initial={false}
 animate={{
 opacity: active? 1: 0,
 width: active? 28: 0,
