...
export function ServiceWorkerRegister() {
 ...
 // FIX(v4-PWA): قبلاً فقط در production ثبت می‌شد — برای اینکه تجربه‌ی آفلاین
 // PWA در پیش‌نمایش dev هم قابل تست باشد، در همه‌ی محیط‌ها ثبت می‌شود.
 // sw.js همه‌ی مسیرهای مهم را network-first سرو می‌کند؛ آنلاین همیشه پاسخ
 // زنده برمی‌گردد و کش فقط fallback قطع اتصال است — برای dev بی‌خطر است.
