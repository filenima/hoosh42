...
// v12.1: کاربران باگ‌ها را با اسکرین‌شات گزارش می‌کنند. در صورت تأیید
// سوپرادمین، اشتراک یک‌ماهه پلن حرفه‌ای رایگان فعال می‌شود.
...
const STATUS_META: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
 ...
 APPROVED: { label: "تأیید شد", color: "bg-emerald-500/10 text-emerald-600 border-emerald-500/30", icon: <CheckCircle2 className="h-3.5 w-3.5" /> },
...
export function BugReportModule() {
 ...
 description: json.message || "در صورت تأیید، اشتراک یک‌ماهه پلن حرفه‌ای برای شما فعال می‌شود.",
 });
 setTitle("");
 setDescription("");
 setSeverity("medium");
 ...
 <h3 className="text-sm font-bold">باگ پیدا کردید؟ پاداش بگیرید!</h3>
 <p className="text-xs text-muted-foreground leading-relaxed">
 هر باگی که با اسکرین‌شات گزارش دهید و توسط تیم فنی تأیید شود،{' '}
 <span className="font-semibold text-primary">اشتراک یک‌ماهه پلن حرفه‌ای رایگان</span>{' '}
 ...
 <SelectContent>
 <SelectItem value="low">کم — مزاحم نیست</SelectItem>
 <SelectItem value="medium">متوسط — کار را سخت می‌کند</SelectItem>
 <SelectItem value="high">زیاد — بخشی از کار نمی‌شود</SelectItem>
 <SelectItem value="critical">بحرانی — داده/پول در خطر است</SelectItem>
 </SelectContent>
 </Select>
 </div>
 </div>
 ...
 <p className="text-xs">هنوز گزارشی ثبت نکرده‌اید — اولین باگ را گزارش کنید و پاداش بگیرید!</p>
 </div>
 ) : (
 ...
 <span className="font-medium">پاسخ تیم فنی: </span>
 {r.adminNote}
 </div>
 )}
 </div>
